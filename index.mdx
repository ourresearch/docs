...
Different API operations have different costs. See [rate limits and authentication](/guides/authentication) for details.
...
The API has a free daily limit of $1/day, and the snapshot is updated monthly. If you need a higher limit, or more frequent updates, please look into a [**paid plan**](https://openalex.org/pricing).
