...
We offer a fast, modern REST API to get OpenAlex data programmatically. It's free but requires an API key (also free). Get yours at [openalex.org/settings/api](https://openalex.org/settings/api). With your free key, you get 10,000 credits per day. [Learn more](/api-reference/introduction)
...
The API has a limit of 10,000 credits per day, and the snapshot is updated monthly. If you need a higher limit, or more frequent updates, please look into a [**paid plan**](https://openalex.org/pricing).
