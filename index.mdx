...
The API has a free daily limit of $1/day, and the free snapshot is updated monthly. If you need a higher API limit, or **daily change files** to keep a local copy in sync with ours, you'll need a [**paid plan**](https://openalex.org/pricing). Need daily updates? Contact [sales@openalex.org](mailto:sales@openalex.org).
