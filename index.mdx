...
The API has a free daily limit of $1/day, and the free snapshot is updated quarterly. If you need a higher API limit or **monthly snapshots**, you'll need a [**paid plan**](https://openalex.org/pricing). Contact [sales@openalex.org](mailto:sales@openalex.org).
