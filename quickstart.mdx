...
```bash
https://api.openalex.org/find/works?query=machine+learning+in+healthcare&api_key=YOUR_KEY
```
...
```bash TEI XML
https://content.openalex.org/works/W2741809807.grobid-xml?api_key=YOUR_KEY
```
</CodeGroup>
...
<CardGroup cols={2}>
  <Card title="Works" icon="file-lines" href="/guides/works">
    Journal articles, books, datasets, theses
  </Card>
  <Card title="Authors" icon="user" href="/guides/authors">
