...
The complete OpenAlex database as gzip-compressed JSON Lines files. The free public snapshot is updated quarterly; [paid plans](https://openalex.org/pricing) get monthly snapshots and daily change files. Includes works, authors, sources, institutions, topics, publishers, funders, and more.
