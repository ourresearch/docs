...
Once you have the files, load them into a database:

<CardGroup cols={2}>
  <Card title="Data warehouse" icon="database" href="/download/data-warehouse">
    Load JSON directly into BigQuery, Snowflake, or similar
  </Card>
  <Card title="Relational database" icon="table" href="/download/relational-database">
    Flatten to normalized tables in PostgreSQL or MySQL
  </Card>
</CardGroup>
