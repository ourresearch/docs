...
Enterprise users can download a monthly snapshot using the steps below.
...
The latest snapshot includes parquet format, which will be added to the free quarterly snapshot beginning June 2026. If you're interested in monthly snapshots, contact sales@openalex.org.