...
<Warning>
**Daily changefiles require a paid plan.** The free public snapshot is refreshed monthly. The `/changefiles` API and the daily incremental files documented on this page are only available to subscribers on a [paid plan](https://openalex.org/pricing). Need daily updates? Contact [sales@openalex.org](mailto:sales@openalex.org).
</Warning>
