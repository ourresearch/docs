...
<Warning>
The free public snapshot is refreshed **quarterly**. **Monthly snapshots** and **daily change files** (via the [Changefiles API](/download/changefiles)) require a [paid plan](https://openalex.org/pricing). Contact [sales@openalex.org](mailto:sales@openalex.org).
</Warning>
