...
<Warning>
The free public snapshot is refreshed **quarterly**. A **daily-refreshed snapshot** requires a [paid plan](https://openalex.org/pricing). Contact [sales@openalex.org](mailto:sales@openalex.org).
</Warning>
