...
For downloading individual files via the API, see [Content downloads](/guides/content-downloads).

## Download options

### Option 1: API (up to ~10K files)

Use the [content API](/guides/content-downloads) to download files one at a time. Each download costs **100 credits**.
