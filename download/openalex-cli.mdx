...
|---------------|------|
| Metadata | Free |
| PDFs | 100 credits each |
| TEI XML | 100 credits each |

With a free API key (10K credits/day), you can download unlimited metadata and about 100 content files per day.
