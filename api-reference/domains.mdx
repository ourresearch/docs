...
These fields can be used with the `filter`, `sort`, and `group_by` parameters when listing domains.
All 8 fields below support `filter`. The **Sort** and **Group_by** columns indicate additional support.
