...
{% hint style="info" %}
Each service type has a different credit cost. Single entity lookups cost 1 credit, list queries cost 10 credits per page, content downloads cost 100 credits per file, and semantic search costs 100 credits per query. See [Rate limits and authentication](rate-limits-and-authentication.md) for details.
{% endhint %}
