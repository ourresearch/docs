...
{% hint style="warning" %}
Semantic search requires an API key and costs **10 credits per query**. See [rate limits](rate-limits-and-authentication.md) for details.
{% endhint %}
