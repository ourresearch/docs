...
**Replacement:** Use [Topics](/guides/topics-and-keywords) instead.

**Why Topics are better:**
- More granular classification (4,500 topics vs 65,000 concepts)
...
**Costs:** 1,000 credits per request.
...
- Check the [Changelog](/changelog/overview)
