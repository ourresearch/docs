...
| List | `/works?filter=...` | 1 |
| Search | `/works?search=...` or `filter=display_name.search:...` | 10 |
| Content download | `content.openalex.org/works/{id}.pdf` | 100 |
| Semantic search | `/works?search.semantic=...` | 100 |
...
- **10,000** search requests, or
- **1,000** content downloads or semantic searches, or
...
|----------|---------|-------------------|-------|
| [Search](/guides/searching) | 10 | ~10,000 requests | `?search=` or `.search` filters |
| [Content downloads](/guides/content-downloads) | 100 | ~1,000 files | PDF or TEI XML |
| [Semantic search](/guides/similar-works) | 100 | ~1,000 requests | AI embeddings |
