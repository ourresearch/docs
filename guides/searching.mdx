...
For a step-by-step walkthrough that uses these patterns to find works missing from an author profile, see the [Find Missing Works for an Author Profile recipe](/guides/recipe-find-missing-author-works).
