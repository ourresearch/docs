...
To surface works that *should* belong to an author profile but aren't currently attributed there, see the [Find Missing Works for an Author Profile recipe](/guides/recipe-find-missing-author-works).
