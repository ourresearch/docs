...
https://api.openalex.org/works?filter=grants.funder:F4320306076&sort=-publication_date

# Step 3: Narrow to works acknowledging a specific grant number
https://api.openalex.org/works?filter=grants.funder:F4320306076,grants.award_id:R01-GM123456

# Step 4: Combine with other filters — e.g., funded OA works from 2024
https://api.openalex.org/works?filter=grants.funder:F4320306076,publication_year:2024,open_access.is_oa:true&sort=-cited_by_count
```
...
https://api.openalex.org/works?filter=default.search:CRISPR,has_content.pdf:true,publication_year:2023-2024
