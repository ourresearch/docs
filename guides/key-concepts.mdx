...
|--------|-------------|-------|
| [Works](/guides/works) | Scholarly documents (articles, books, datasets, theses) | 270M+ |
| [Authors](/guides/authors) | Researchers who create works | 90M+ |
...
```bash
# Without XPAC: ~278 million works
curl "https://api.openalex.org/works"

# With XPAC: ~470 million works
